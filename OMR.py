...
num_epoch = 10
num_classes = 224
dir_image = 'Burgmein/La secchia rapita (1)'
...
def get_dataset(path):
    ...
    """
    trainset = Custom_Dataset.train_dataset
    valset = Custom_Dataset.valid_dataset
    testset = Custom_Dataset.test_dataset
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    print(preds)
                    print(labels)
                   # print(list(outputs.shape()),list(labels.shape()))
...
def weighted_score(models,dataset):
...
def prediction():
    ...
    trainset,valset,testset= get_dataset(dir_image)
    models = model_list()
    for model in models:
        ...
        train_X, train_Y = weighted_score(model,trainset)
        test_X, test_Y = weighted_score(model,testset)
